...
public class MainActivity extends AppCompatActivity {
    ...
    String no_telp = "082221417262";
    String email = "Djazulimuhtar@gmail.com";
    ...
    public void Email(View view) {
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto","djazulimuhtar@gmail.com", null));
